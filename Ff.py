...
logo = "'\x1b[1;92m' \n    ########     ###          ##    ###    \n    ##     ##   ## ##         ##   ## ##   \n    ##     ##  ##   ##        ##  ##   ##  \n    ########  ##     ##       ## ##     ## \n    ##   ##   ######### ##    ## ######### \n    ##    ##  ##     ## ##    ## ##     ## \n    ##     ## ##     ##  ######  ##     ##\n\n\n'\x1b[1;91m'   Author      :     NAZIM KHAN   \n'\x1b[1;92m'   Github      :     SKCYBER \n'\x1b[1;92m'   KING OF     :     NAZIM\n'\x1b[1;91m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;92m'   WAP NUMBER  :     01876276757           \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        print '           Apnar Subscription Please Ap'
        print '           Admin Nazim Khan Thanks'
        print '           Subscription Ar Jonno Enter Press Koren'
        print '          Whatsapp a sent Koren Thanks'
        print ''
        ...
        kok.close()
        print ''
        print '           Opore Apnar KEY Ase'
        print '           Copy Kore WhatsApp a Diba'
        print ''
        print ''
        print ''
...
def main_system():
    ...
    print '\x1b[1;91m[2]   Random Cloning     \x1b[1;92m (On Login)'
    print '\x1b[1;92m[3]   File Cloning       \x1b[1;92m ( Login)'
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Admin Nazim Paid Commands '
        print '\x1b[1;91m        ENJOY  WIKI-KING '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
